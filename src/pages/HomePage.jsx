  ...
  return (
    <div className='min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300'>
       <section className='relative
              bg-gradient-to-br from-emerald-600 via-emerald-700 to-blue-700
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
             {features.map((features, index) =>(
              <div key={index} className='text-center p-6 rounded-lg hover:shadow-lg group'>
                ...
                <h3 className='text-xl font-semibold text-gray-800 dark:text-white mb-2'>{features.title}</h3>
                <p className='text-gray-600 dark:text-white'>{features.description}</p>
              </div>
             ))}
          </div>
        </div>
       ...
       <section className='py-20
        ...
        <div className='max-w-7x mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            <h2 className='text-4xl font-bold mb-4 dark:text-white'>Popular Gyms & Studios</h2>
            <p className='text-xl text-gray-800 dark:text-white'>Discover top-rated fitness facilities loved by our community</p>
          </div>
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800'>
            {featuredGyms.map((gym, index) =>(
              <div key={gym.id} className='bg-gray-100 rounded-2xl shadow-md overflow-hidden hover:shadow-lg 
              transition-shadow duration-300 dark:text-white dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800'>
                ...
                <div className='p-6'>
                  <h3 className='text-xl font-semibold text-gray-800 dark:text-white mb-2'>{gym.name}</h3>
                  <p className='text-gray-600 dark:text-white mb-4'>{gym.location}</p>
